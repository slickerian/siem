...
const Events = () => {
  ...
  const loadLogs = useCallback(async () => {
    ...
    try {
      ...
      if (selectedEventType && selectedEventType !== "all") apiParams.event_type = selectedEventType;

      console.log(`[PERF] Fetching logs for Events page...`);
      ...
      console.error(`[ERROR] Logs load failed: ${msg}`);
      setError(msg);
      toast({
        ...
        <div>
          ...
          <Select value={selectedEventType} onValueChange={setSelectedEventType}>
            ...
            <SelectContent>
              ...
              <SelectItem value="ACTION_FAILED">ACTION_FAILED</SelectItem>
              {/* Add more as needed */}
            </SelectContent>
          </Select>
        </div>
